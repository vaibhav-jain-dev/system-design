...
func registerPatterns(r *Registry) {
  ...
  <div class="d-number"><div class="d-number-value">2-4</div><div class="d-number-label">Typical iterations to complete</div></div>
  <div class="d-number"><div class="d-number-value">1</div><div class="d-number-label">Tool call per iteration</div></div>
</div>
<div class="d-flow-v">
  ...
  <div class="d-group">
    <div class="d-group-title">Agent Loop (repeat until done) <div class="d-tag amber">max 3-5 iterations</div></div>
    <div class="d-flow-v">
      ...
      <div class="d-arrow-down">&#8595;</div>
      <div class="d-box amber" data-tip="Agent executes exactly ONE tool call per iteration. Tool choice is constrained by the available tool schema. Best practice: keep tool descriptions under 200 tokens each."><span class="d-step">3</span> ACT — Call a tool (e.g. web_search) <span class="d-metric latency">50-5000ms</span> <div class="d-tag indigo">1 tool/iteration</div></div>
      <div class="d-arrow-down">&#8595;</div>
      <div class="d-box indigo" data-tip="Tool output is appended to the conversation context. Truncate large outputs to avoid context window overflow. Typical limit: keep observation under 4K tokens."><span class="d-step">4</span> OBSERVE — Read tool result <div class="d-tag gray">&lt;4K tokens</div></div>
      <div class="d-arrow-down">&#8595;</div>
      <div class="d-branch">
        <div class="d-branch-arm">
          <div class="d-label">Task complete?</div>
          <div class="d-box red" data-tip="Loop continues. Best practice: set a max iteration limit (3-5) to prevent runaway costs and infinite loops.">No &#8594; loop back to REASON <span class="d-status error"></span></div>
        </div>
        <div class="d-branch-arm">
          <div class="d-label">Task complete?</div>
  ...
  <div class="d-arrow-down">&#8595;</div>
  <div class="d-box purple" data-tip="Final answer is formatted and returned. Include source attribution from tool results. Total latency = N iterations x (LLM + tool) time."><span class="d-step">5</span> FINAL ANSWER — Formatted response to user <span class="d-status active"></span></div>
  ...
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">1. Simple Agent <div class="d-tag green">start here</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box amber" data-tip="All tools share one namespace. Typical limit: 10-20 tools before LLM accuracy degrades on tool selection.">Tools <div class="d-tag amber">max 10-20</div></div>
      </div>
    </div>
  </div>
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">2. Router Agent <div class="d-tag indigo">distinct task types</div></div>
      <div class="d-flow-v">
        <div class="d-box blue" data-tip="Single entry point. Router classifies incoming queries.">User</div>
        <div class="d-arrow-down">&#8595;</div>
  ...
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">3. Multi-Agent <div class="d-tag amber">complex workflows</div></div>
      <div class="d-flow-v">
        <div class="d-box blue" data-tip="Single entry point but complex multi-step tasks.">User</div>
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Orchestrator that decomposes tasks and delegates to workers. Pros: parallel execution, separation of concerns. Cons: complex coordination, higher total cost, harder to debug.">Manager Agent <div class="d-tag indigo">parallel execution</div></div>
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-flow">
...
<div class="d-caption">Simple: best for &lt;10 tools. Router: best for distinct task categories. Multi-Agent: best for complex workflows requiring parallel execution and review cycles.</div>`,
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">1536</div><div class="d-number-label">Dimensions (text-embedding-3-small)</div></div>
  <div class="d-number"><div class="d-number-value">0.92</div><div class="d-number-label">Cosine sim: "refund" vs "return"</div></div>
</div>
<div class="d-coord" style="height: 320px;">
  ...
  <div class="d-coord-point" style="left: 40%; top: 12%; background: var(--blue);" data-tip="'refund policy' — semantic cluster: returns/refunds. Cosine similarity to 'return process': 0.92. Embedding dim: 1536 (text-embedding-3-small)."></div>
...
<div class="d-legend">
  <span style="display:inline-block;width:10px;height:10px;background:var(--blue);border-radius:50%;vertical-align:middle;"></span> Returns/refunds cluster &nbsp;
  <span style="display:inline-block;width:10px;height:10px;background:var(--green);border-radius:50%;vertical-align:middle;margin-left:1rem;"></span> Product specs cluster &nbsp;
  <span style="display:inline-block;width:10px;height:10px;background:var(--amber);border-radius:50%;vertical-align:middle;margin-left:1rem;"></span> Unrelated (weather)
</div>
<div class="d-caption">Real embeddings are 768-3072 dimensions projected to 2D here. Cosine similarity &gt; 0.8 = strong match. &lt; 0.3 = unrelated. Clustering quality depends on model choice (e.g. text-embedding-3-large outperforms ada-002).</div>`,
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">O(log N)</div><div class="d-number-label">Average search complexity</div></div>
  <div class="d-number"><div class="d-number-value">1-5ms</div><div class="d-number-label">Query latency (1M vectors)</div></div>
</div>
<div class="d-graph">
  <div class="d-graph-layer" data-tip="Layer 2: Entry point for search. Only ~1% of nodes appear here. Long-range connections enable O(log N) jumps across the graph. Search starts at a random entry node on this layer.">
    <div class="d-graph-layer-label">Layer 2 (sparse) — entry point, long jumps <div class="d-tag indigo">~1% of nodes</div></div>
  ...
  <div class="d-graph-layer" data-tip="Layer 1: Medium density. More nodes, shorter edges. Search descends here after finding approximate region in Layer 2. Each node connects to M neighbors.">
    <div class="d-graph-layer-label">Layer 1 (medium) — refine neighborhood <div class="d-tag amber">M neighbors each</div></div>
    <div class="d-graph-nodes">
  ...
  <div class="d-graph-layer" data-tip="Layer 0: All nodes present. Dense connections for precise nearest-neighbor search. Final results come from this layer. This is where ef_search controls recall quality.">
    <div class="d-graph-layer-label">Layer 0 (dense) — all nodes, precise results <div class="d-tag green">ef_search controls recall</div></div>
    <div class="d-graph-nodes">
...
<div class="d-legend">
  <span style="display:inline-block;width:10px;height:10px;background:var(--purple);border-radius:50%;vertical-align:middle;"></span> Layer 2 (sparse) &nbsp;
  <span style="display:inline-block;width:10px;height:10px;background:var(--blue);border-radius:50%;vertical-align:middle;margin-left:1rem;"></span> Layer 1 (medium) &nbsp;
  <span style="display:inline-block;width:10px;height:10px;background:var(--green);border-radius:50%;vertical-align:middle;margin-left:1rem;"></span> Layer 0 (all nodes)
</div>
<div class="d-caption">Search complexity: O(log N) average. For 1M vectors with M=16, ef_search=64: ~1-5ms query latency. Index build time: O(N log N). Memory: ~1.5x raw vectors. Trade-off: higher M = better recall but more memory and slower inserts.</div>`,
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">~2 hrs</div><div class="d-number-label">Indexing 1M documents</div></div>
  <div class="d-number"><div class="d-number-value">~25ms</div><div class="d-number-label">End-to-end query latency</div></div>
</div>
<div class="d-cols">
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">Indexing Path <div class="d-tag indigo">offline batch</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Chunk strategy matters: 256-512 tokens per chunk with 50-token overlap. Too small = lost context. Too large = diluted relevance. Use recursive text splitter for best results."><span class="d-step">2</span> Document Processor (chunk, clean) <span class="d-metric throughput">~500 docs/s</span> <div class="d-tag amber">512 tokens/chunk</div></div>
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Batch embedding is 10-50x cheaper than single calls. OpenAI: $0.02/1M tokens. Self-hosted (e5-large): ~$0.002/1M tokens but requires GPU. Batch size: 100-2000 texts per API call."><span class="d-step">3</span> Embedding API (batch) <span class="d-metric latency">~20ms/chunk</span> <div class="d-tag green">batch 100-2000</div></div>
        <div class="d-arrow-down">&#8595;</div>
  ...
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">Query Path <div class="d-tag green">online ~25ms</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box amber" data-tip="CRITICAL: Must use the EXACT same model as indexing. Mixing models (e.g. ada-002 index + text-embedding-3 query) produces garbage results."><span class="d-step">B</span> Embed Query (same model!) <span class="d-metric latency">~20ms</span> <div class="d-tag amber">must match index model</div></div>
        <div class="d-arrow-down">&#8595;</div>
...
<div class="d-caption">Total indexing: ~2 hours for 1M documents. Query path end-to-end: ~25ms (embed + search). Cost at scale: embedding dominates indexing cost, pgvector hosting dominates operational cost.</div>`,
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">~180ms</div><div class="d-number-label">Total guard overhead</div></div>
  <div class="d-number"><div class="d-number-value">~5%</div><div class="d-number-label">Added to LLM latency</div></div>
</div>
<div class="d-flow-v">
  ...
  <div class="d-row">
    <div class="d-group">
      <div class="d-group-title">Input Guardrails (cheapest first) <div class="d-tag green">fail fast</div></div>
      <div class="d-flow-v">
    ...
    <div class="d-flow-v">
      ...
      <div class="d-box red" data-tip="Fail fast: return specific error message for each guard type. Log the failure reason for monitoring. Never expose internal guard details to user.">Return error / ask to rephrase <span class="d-status error"></span></div>
    </div>
  </div>
  <div class="d-arrow-down">&#8595; Pass <span class="d-status active"></span></div>
  ...
  <div class="d-row">
    <div class="d-group">
      <div class="d-group-title">Output Guardrails (cheapest first) <div class="d-tag amber">catch hallucinations</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-box amber" data-tip="Most expensive guard: cross-reference claims against retrieved sources. Use NLI model (Natural Language Inference) to check entailment. Critical for RAG systems."><span class="d-step">4d</span> Hallucination check <span class="d-metric latency">~100ms</span> <div class="d-tag amber">most expensive</div></div>
      </div>
    </div>
    <div class="d-flow-v">
      <div class="d-label">Fail?</div>
      <div class="d-box red" data-tip="Strategy depends on failure type: format fail = retry with stricter prompt, safety fail = block entirely, hallucination = retry with higher temperature 0.">Retry / fallback / block <span class="d-status error"></span></div>
    </div>
  </div>
  ...
  <div class="d-caption">Order guards cheapest-first to fail fast. Total guard overhead: ~180ms (~5% of LLM latency). Run input guards in parallel where possible. Hallucination check is most expensive but most impactful for trust.</div>
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">~2.4s</div><div class="d-number-label">Total chain latency</div></div>
  <div class="d-number"><div class="d-number-value">max 2</div><div class="d-number-label">Retries per step</div></div>
</div>
<div class="d-flow-v">
  ...
  <div class="d-flow" style="flex-wrap: wrap;">
    <div class="d-flow-v">
      <div class="d-box green" data-tip="Use a focused prompt: 'Extract these 5 fields from the text.' Structured output (JSON mode) ensures downstream steps can parse reliably. Use a cheaper model (GPT-4o-mini) for extraction."><span class="d-step">2</span> EXTRACT key facts <span class="d-metric latency">~400ms</span> <div class="d-tag green">cheap model</div></div>
      <div class="d-label">"key: value ..."</div>
    </div>
    <div class="d-arrow">&#8594;</div>
    <div class="d-flow-v">
      <div class="d-box green" data-tip="Classification from extracted facts, not raw text. Simpler input = more accurate classification. Use constrained output (enum of categories) to prevent hallucinated classes."><span class="d-step">3</span> CLASSIFY category <span class="d-metric latency">~200ms</span> <div class="d-tag green">cheap model</div></div>
      <div class="d-label">"category: X"</div>
    </div>
    <div class="d-arrow">&#8594;</div>
    <div class="d-flow-v">
      <div class="d-box indigo" data-tip="Most expensive step — use the best model here (GPT-4o, Claude). Prompt includes extracted facts + category as context. This is where quality matters most."><span class="d-step">4</span> GENERATE response <span class="d-metric latency">~1500ms</span> <div class="d-tag indigo">premium model</div></div>
      <div class="d-label">"Dear user..."</div>
    </div>
    <div class="d-arrow">&#8594;</div>
    <div class="d-flow-v">
      <div class="d-box amber" data-tip="Quality gate: check tone, factual consistency with extracted facts, format compliance. Use a different model than generator to avoid self-confirmation bias."><span class="d-step">5</span> VALIDATE quality <span class="d-metric latency">~300ms</span> <div class="d-tag amber">different model</div></div>
  ...
  <div class="d-branch">
    <div class="d-branch-arm">
      <div class="d-box red" data-tip="Retry includes the validation error as feedback. 'Your response failed because: [reason]. Please regenerate.' Max 2 retries to cap cost. After 2 failures, escalate to human.">FAIL &#8594; Retry Step 3 (max 2x) <span class="d-status error"></span></div>
    </div>
    <div class="d-branch-arm">
  ...
  <div class="d-caption">Total chain latency: ~2.4s (sequential). Each step uses focused prompts for higher accuracy than a single monolithic prompt. Cost optimization: use cheaper models for extraction/classification, premium models for generation.</div>
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">80%+</div><div class="d-number-label">Quality issues caught by gates</div></div>
  <div class="d-number"><div class="d-number-value">~10-20%</div><div class="d-number-label">Added latency per gate</div></div>
</div>
<div class="d-flow-v">
  <div class="d-box blue" data-tip="Output from the preceding chain step. Should be structured (JSON) to make validation deterministic. Include schema version for forward compatibility.">Step N Output <div class="d-tag indigo">prefer JSON</div></div>
  <div class="d-arrow-down">&#8595;</div>
  <div class="d-box amber" data-tip="Gate validator can be: (1) LLM-as-judge with rubric, (2) deterministic code checks (regex, schema), or (3) hybrid. Deterministic checks are cheaper and more reliable — use LLM-as-judge only for subjective quality.">GATE Validator <span class="d-metric latency">~50-300ms</span> <div class="d-tag green">deterministic first</div></div>
  <div class="d-arrow-down">&#8595;</div>
  <div class="d-branch">
    <div class="d-branch-arm">
    ...
    <div class="d-branch-arm">
      <div class="d-box red" data-tip="Gate returns structured failure reason: {passed: false, reason: 'tone too formal', suggestion: 'use casual language'}. This feedback is critical for effective retry.">FAIL <span class="d-status error"></span></div>
      <div class="d-arrow-down">&#8595;</div>
      <div class="d-box amber" data-tip="Append gate feedback to the retry prompt: 'Previous attempt failed: [reason]. Please fix: [suggestion].' Each retry costs one LLM call. Exponential backoff not needed — LLM retries are deterministic.">Retry Step N with error feedback (max 2-3 retries) <div class="d-tag amber">include failure reason</div></div>
      <div class="d-arrow-down">&#8595;</div>
      <div class="d-box red" data-tip="After max retries: (1) return best attempt with confidence score, (2) route to human review queue, or (3) use a pre-written fallback template. Never silently fail.">Still FAIL &#8594; Abort chain or use fallback <span class="d-status error"></span> <div class="d-tag gray">escalate to human</div></div>
    </div>
  </div>
  <div class="d-caption">Gates add ~10-20% latency but catch 80%+ of quality issues before they propagate downstream. Use deterministic gates where possible (schema validation, regex) and reserve LLM-as-judge for subjective criteria.</div>
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">~700ms</div><div class="d-number-label">Query path (no rerank)</div></div>
  <div class="d-number"><div class="d-number-value">512 tokens</div><div class="d-number-label">Recommended chunk size</div></div>
</div>
<div class="d-cols">
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">OFFLINE: Indexing Phase <div class="d-tag indigo">one-time batch</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Chunk size is the #1 tuning knob. Start with 512 tokens, 50-token overlap. Use recursive character splitter to respect paragraph boundaries. Too small = lost context, too large = noise in retrieval."><span class="d-step">2</span> Chunk Documents <span class="d-metric latency">~2ms/doc</span> <div class="d-tag amber">512 tokens, 50 overlap</div></div>
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Batch embed for cost efficiency. OpenAI text-embedding-3-small: $0.02/1M tokens, 1536 dims. Self-hosted e5-large: cheaper but requires GPU. Batch size 100-2000 per API call."><span class="d-step">3</span> Embed Chunks <span class="d-metric latency">~20ms/chunk</span> <div class="d-tag green">batch 100-2000</div></div>
        <div class="d-arrow-down">&#8595;</div>
  ...
  <div class="d-col">
    <div class="d-group">
      <div class="d-group-title">ONLINE: Query Phase <div class="d-tag green">~700ms total</div></div>
      <div class="d-flow-v">
        ...
        <div class="d-arrow-down">&#8595;</div>
        <div class="d-box green" data-tip="Must use the SAME embedding model as indexing. Single query embedding is fast. Consider HyDE: generate a hypothetical answer first, then embed that for better retrieval."><span class="d-step">B</span> Embed Query <span class="d-metric latency">~20ms</span> <div class="d-tag amber">same model as index!</div></div>
        <div class="d-arrow-down">&#8595;</div>
...
<div class="d-caption">Indexing is a one-time batch job (~2hrs for 1M docs). Query path end-to-end: ~700ms without rerank, ~800ms with. LLM generation dominates latency. Optimize retrieval quality first, then latency.</div>`,
	...
	r.Register(&Diagram{
		...
		Type:        TypeHTML,
		HTML: `<div class="d-flow" style="gap: 1.5rem; margin-bottom: 0.75rem; flex-wrap: wrap;">
  <div class="d-number"><div class="d-number-value">+15-30%</div><div class="d-number-label">Precision gain from reranking</div></div>
  <div class="d-number"><div class="d-number-value">~110ms</div><div class="d-number-label">Total retrieval latency</div></div>
</div>
<div class="d-flow-v">
  ...
  <div class="d-arrow-down">&#8595;</div>
  <div class="d-row">
    <div class="d-box green" data-tip="Bi-encoder: query and documents are embedded independently. Fast because document embeddings are precomputed. Combine dense (semantic) + BM25 (keyword) for hybrid search — typically 10-15% better recall than either alone."><span class="d-step">2</span> Stage 1: Retrieve<br>Bi-encoder search (dense + BM25) <div class="d-tag green">precomputed embeddings</div></div>
